			...
			<div class="container">
				...
				<nav>
					<ul>
						...
						<li class="current"><a href="control.php">control</a></li>
						<li><a href="monitor.php">monitor</a></li>
						<li><a href="http://192.168.137.170/html/index.php">stream</a></li>
		 	...
		 	<div class="container">
	        	...
	        	<a onclick="changecolor('black')" id="black">#000000</a>
			  	...
			  	<div class="upper">
			  		...
			  		<ul>
			  			<form action="" method="POST">
                            <li><input type="submit" value="Relay1" id="Relay1" class="button_2" name="Relay1" "></li>
                            <li><input type="submit" value="Relay2" id="Relay2" class="button_2" name="Relay2" "></li>
			  		    </form>
			  		</ul>
			 	...
			 	<div class="lower">
			  		<ul>
			  		    <form action="" method="POST">
				  			<li><input type="submit" value="Relay3" id="Relay3" class="button_2" name="Relay3" "></li>
				  			<li><input type="submit" value="Relay4" id="Relay4" class="button_2" name="Relay4" "></li>
				  			<li><input type="submit" value="Relay5" id="Relay5" class="button_2" name="Relay5" "></li>
			  			</form>
			  		</ul>
			 	</div>		
		  	</div>
